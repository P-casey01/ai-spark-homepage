  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-4xl text-center z-10">
        <h1 className="text-2xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-6 text-gray-900">
          Transform Your Business with{' '}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-green-400">
            Intelligent Automation
          </span>
        </h1>
        <p className="text-sm md:text-xl text-gray-700 mb-4 md:mb-8">
          Auto-mate Consultants: Driving Business Efficiency through Cutting-Edge Automation
        </p>
        <Button className="inline-flex items-center bg-gray-900 text-white py-2 md:py-4 px-4 md:px-8 rounded-full shadow-lg hover:shadow-xl transition group text-xs md:text-base">
