...
const HeroSection: React.FC = () => {
  return (
    <WavyBackground
      className="min-h-[80vh] px-4 py-16 flex flex-col items-center justify-center overflow-hidden"
      ...
      waveOpacity={0.7}
    >
      <div className="container mx-auto px-4 md:max-w-3xl text-center z-10 mt-16 pt-10">
