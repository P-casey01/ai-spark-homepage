  ...
  return (
    <WavyBackground
      ...
      colors={[
        ...
        "#0f172a", // Darker blue
        "#064e3b", // Dark emerald
        "#065f46", // Darker emerald
      ]}
      waveWidth={100}
      backgroundFill="rgba(2, 6, 23, 0.95)" // Very dark background
      blur={12}
      speed="fast"
      waveOpacity={0.7}
    >
      <div className="container mx-auto px-4 md:max-w-3xl text-center z-10">
        <div className="backdrop-blur-sm bg-slate-950/40 rounded-xl p-3 md:p-6">
          ...
          <p className="text-base md:text-xl text-slate-300 font-medium mb-3 md:max-w-lg mx-auto">
